package com.lin.domain.strategy.service.rule.tree.factory.engine.impl;

import com.lin.domain.strategy.model.valobj.RuleLogicCheckTypeVO;
import com.lin.domain.strategy.model.valobj.RuleTreeNodeLineVO;
import com.lin.domain.strategy.model.valobj.RuleTreeNodeVO;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardVO process(String userId, Long strategyId, Integer awardId, Date endDateTime) {
        ...
        while (null != nextNode) {
            ...
            // 决策节点计算  TreeActionEntity：{LogicCheckType ,strategyAwardData}
    ...
    //matterValue:如果是ALLOW的话就是放行
    public String nextNode(String matterValue, List<RuleTreeNodeLineVO> treeNodeLineVOList) {
        if (null == treeNodeLineVOList || treeNodeLineVOList.isEmpty()) return null;
        for (RuleTreeNodeLineVO nodeLine : treeNodeLineVOList) {
            //规则节点得到的matterValue和节点的RuleLimitValue比较，判断走哪一条路
