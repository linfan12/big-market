...
public class DCCValueBeanFactory implements BeanPostProcessor {
    ...
    public DCCValueBeanFactory() throws Exception {
        ...
        /**
         * 创建缓存，监听BASE_CONFIG_PATH_CONFIG路径及其所有子节点。
         */
    ...
    /**
     * 1 Bean 中带有@DCCValue注解的字段；
     * 2 从 ZooKeeper 中读取对应节点的配置值，注入到字段；
     * 3 若 ZooKeeper 中无对应节点，自动创建节点并设置注解中的默认值；
     * 4 记录节点与 Bean 的映射，为后续配置动态更新做准备。
     * @param bean
     * @param beanName
     * @return
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        for (Field field : fields) {
            ...
            //获取@DCCValue("degradeSwitch:open")上的值
