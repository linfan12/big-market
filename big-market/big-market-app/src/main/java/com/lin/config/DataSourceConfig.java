...
public class DataSourceConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "com.lin.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "com.lin.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
